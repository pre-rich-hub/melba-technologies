...
export const caseStudies: CaseStudy[] = [
  {
    ...
    technologies: ["Next.js", "Django", "PostgreSQL", "Cloudinary", "Tailwind CSS", "i18n", "SEO Architecture"],
    timeline: "6 weeks",
  ...
  },
  {
    ...
    solution: "We designed and developed a high-performance website using Next.js, TypeScript, Tailwind CSS, Framer Motion, and Cloudinary. We created a refined brand identity and logo, implemented SEO best practices, built responsive and conversion-focused pages with strategic CTAs, optimized images and performance, and delivered a polished experience that effectively showcases Ethiopia's tourism offerings while driving customer inquiries.",
    technologies: ["Next.js", "TypeScript", "Tailwind CSS", "Framer Motion", "Cloudinary", "SEO"],
